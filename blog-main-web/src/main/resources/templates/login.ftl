...
<div class="container">
    ...
    <form class="form-horizontal">
        ...
        <div class="form-inline form-group">
                ...
                <label for="validatecode" class="col-sm-offset-3 col-sm-2 control-label">validatecode</label>
                <div class="col-sm-2">
                    <input type="password" class="form-control" style="width: 100%" id="validatecode" placeholder="validatecode">
                </div>
                <div class="col-sm-1">
